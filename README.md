...
*I nstall with ``` git clone https://github.com/TxHammer68/pirateWeather && kpackagetool6 -t Plasma/Applet -i ./pirateWeather/```
* Upgrade with ``` git clone https://github.com/TxHammer68/pirateWeather && kpackagetool6 -t Plasma/Applet -u ./pirateWeather/```
